...
import { BookOpen, Shield, Zap, Search, ArrowRight, Library, Layers, Globe } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-indigo-100">
      ...
      <nav className="flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-slate-800">LibroFlow</span>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-8 pt-20 pb-32 text-center">
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-slate-900 mb-6 leading-[0.9]">
          BOOK <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-600 to-violet-600">MANAGEMENT</span>
          <br />
          <span className="text-slate-400">REIMAGINED.</span>
        </h1>

        <p className="max-w-2xl mx-auto text-lg text-slate-500 mb-10 leading-relaxed">
          The all-in-one workspace for modern libraries. Catalog, track, and scale your
          collection with a beautiful interface designed for clarity and speed.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <a href="/addbook"> <button className="w-full sm:w-auto bg-indigo-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-indigo-700 transition-all transform hover:-translate-y-1 shadow-xl shadow-indigo-200 flex items-center justify-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 text-left">
          <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:border-indigo-200 transition-colors group">
            ...
            <h3 className="text-xl font-bold mb-3 text-slate-800">Digital Cataloging</h3>
            <p className="text-slate-500 leading-relaxed">Automatically fetch metadata, covers, and ISBN details with our lightning-fast global database.</p>
          </div>
          ...
          <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:border-indigo-200 transition-colors group">
            ...
            <h3 className="text-xl font-bold mb-3 text-slate-800">Inventory Logic</h3>
            <p className="text-slate-500 leading-relaxed">Smart tracking for borrowed books, due dates, and stock levels across multiple branches.</p>
          </div>
          ...
          <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:border-indigo-200 transition-colors group">
            ...
            <p className="text-slate-500 leading-relaxed">Access your entire library collection from any device, anywhere in the world, in real-time.</p>
          </div>
        </div>
      </main>
